...
function newsolicitacao({ navigation }) {
  moment.locale('pt')
  ...
  async function Solicitar() {
    ...
    try {
      if (!Disc) {
        return toggleModalAlertaInfo("Disciplina não foi informada!")
      }
      if (!Sala) {
        return toggleModalAlertaInfo("Sala não foi informada!")
      }
      if (!Datat) {
        return toggleModalAlertaInfo("Data não foi informada!")
      }
      if (!Horarioselecionado) {
        return toggleModalAlertaInfo("O horario não foi selecionado!")
      }
      if (!Recursoselecionado) {
        return toggleModalAlertaInfo("O recurso não foi selecionado!")
      }
      ...
      >
        ...
        <View style={{
          ...
          <View style={styles.GrupoBotoes} >
            ...
            <RectButton style={styles.BotaoAdd} onPress={() => toggleModal()} >
